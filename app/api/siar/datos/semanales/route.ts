...
import { getDatosSemanales } from "@/lib/siar-client";
...
export async function GET(request: Request) {
  try {
    ...
    if (estacionesUnique.length > 0) {
      ...
      const url = new URL(`https://servicio.mapa.gob.es/siarapi/API/V1/Datos/Semanales/${normalizedAmbito}`);
